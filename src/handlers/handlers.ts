...
export const targetHandler: InStockHandler = async (
  driver: WebDriver
): Promise<boolean> => {
  const soldOutBlocks = await driver.findElements(
    By.css("div[data-test='soldOutBlock']")
  );
...
export const gamestopHandler: InStockHandler = async (
  driver: WebDriver
): Promise<boolean> => {
...
export const neweggHandler: InStockHandler = async (
  driver: WebDriver
): Promise<boolean> => {
...
export const walmartHandler: InStockHandler = async (
  driver: WebDriver
): Promise<boolean> => {
